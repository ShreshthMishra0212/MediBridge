...
export const PatientPrescriptions = () => {
  ...
  const getPrescriptionSpeechText = (p, lang) => {
    ...
    if (lang === "hi") {
      return `डॉक्टर ${p.doctor_name || ""} का पर्चा। रोग निदान: ${p.diagnosis || ""}। दवाइयाँ: ${meds}। सलाह: ${p.advice || ""}। अगला परामर्श: ${p.follow_up_date || ""}`;
    }
    return `Prescription from Doctor ${p.doctor_name || ""}. Diagnosis: ${p.diagnosis || ""}. Medicines: ${meds}. Advice: ${p.advice || ""}. Follow up: ${p.follow_up_date || ""}`;
  };
      ...
      <div className="card table-card">
        <div className="table-header">
          ...
          <p className="text-muted" style={{ fontSize: "0.85rem" }}>
            View prescriptions written by your consulting specialist. Listen in English or Hindi, and download PDF or DOCX files.
          </p>
        </div>
          ...
          <div className="card" style={{ maxWidth: "600px", width: "100%", maxHeight: "90vh", overflowY: "auto", position: "relative" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid var(--border)", paddingBottom: "12px", marginBottom: "16px" }}>
              <div>
                ...
                <small className="text-muted">Dr. {selectedPrescription.doctor_name} | {selectedPrescription.date}</small>
              </div>
              <button
                onClick={() => {
